...
// vars
let ProjectName = ref<String>("Softeng Blog");
...
<template lang="pug">
//- Our Header
header(class="overflow-hidden w-full top-0 left-0 h-[var(--HeaderHeight)] flex items-center px-[var(--paddingx)] bg-[var(--LTheme1)] dark:bg-[var(--Theme1)]" data-tauri-drag-region style="user-select: none;")
	...
	//- Dark / Light Button
	div(class="toggleMode h-8 w-16 ml-3 flex flex-row items-center justify-center rounded-full bg-[var(--LTheme4)] dark:bg-[var(--Theme4)] scale-95" @click="darkModeChecked = !darkModeChecked; MT_toggleMode();")
