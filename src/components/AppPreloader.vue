...
<template lang="pug">
div(v-if="isLoading" class="preloader fixed flex items-center justify-center top-0 left-0 w-full h-full z-50 bg-linear-to-r from-black-700/40 to-gray-700/30")
	.upload.loading
		.path
			.arrow
			svg
